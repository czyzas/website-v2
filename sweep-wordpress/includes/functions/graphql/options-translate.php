 ...
 * @throws Exception
 */
// SOURCE: https://github.com/Ririshi/wp-graphql-wpml/blob/feat/acf-options-pages-language-filter/acf-compatibility.php
add_action( 'graphql_register_types', function () {
	register_graphql_field( 'RootQuery', 'themeOptionsByLang', [
		'type'    => 'ThemeOptions',
		'args'    => [
			'lang' => [
				'type'        => 'String',
		...
		'resolve' => function ( $unused, $args ) {
			...
			$options_page = acf_get_options_pages()['options'];
